...
public class BTree<T> extends Tree<T> {
    ...
    public int maxBTree(){
        ...
        int maxLeft=0;
        if(this.right!=null){
            maxRight= Math.max(this.left.maxBTree(),maxRight);;
        }
        if(this.left!=null){
            maxLeft=this.left.maxBTree();
        }
    ...
    public static void main(String[] args){
        BTree<Integer> b=new BTree<>(1,new BTree<Integer>(4));
