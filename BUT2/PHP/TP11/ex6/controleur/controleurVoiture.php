...
class controleurVoiture extends Controleur{
    ...
    public static function afficherFormulaireModification(){
        ...
        $voiture=Voiture::getObjetById($i);
        $i=$voiture->get("immatriculation");
        $m=$voiture->get("marque");
        $c=$voiture->get("couleur"); 
        require_once(__DIR__."/../vue/debut.php");
        require_once(__DIR__."/../vue/menu.html");
        require_once(__DIR__.'/../vue/voiture/formulaireModification.php');
        require_once(__DIR__."/../vue/fin.html");
...
public static function modifierVoiture(){
    Voiture::updateVoiture($_GET["immatriculation"],$_GET["marque"],$_GET["couleur"]);
    self::lireObjets();
}
