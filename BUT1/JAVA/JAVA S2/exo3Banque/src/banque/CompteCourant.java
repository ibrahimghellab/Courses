...
public class CompteCourant {
	...
	public CompteCourant(float solde, float seuilDecouvertAutoriseCC) {
		
		compteurcompte++;
		setNumCC(compteurcompte);
	...
	public void crediter(float argentRajouter) {
		...
		setSoldeCC(getSoldeCC()+argentRajouter*saBanque.getTauxRemuneration());
	}
	...
	public static void main(String[] args) {
		CompteCourant c1=new CompteCourant(1000,11);
		c1.crediter(100);
