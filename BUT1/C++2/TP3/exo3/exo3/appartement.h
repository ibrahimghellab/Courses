...
public:
    ...
    int recherche(const string& name)const;
    ...
    int recherche(const string& name);

    int recherchePremier(const string& name)const;

    int rechercheDernier(const string& name)const;
